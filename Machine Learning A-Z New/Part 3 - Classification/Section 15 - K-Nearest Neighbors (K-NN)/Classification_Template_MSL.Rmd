---
title: "K-Nearest Neighbors classification in R"
...
we'll use the glm function; glm is used to fit generalized linear models, specified by giving a symbolic description of the linear predictor and a description of the error distribution. formula is Dependent variable and ~ then Independent variable, in this case all so '.' classifier = # here we'll apply a dif modeling tool depending on what we need
